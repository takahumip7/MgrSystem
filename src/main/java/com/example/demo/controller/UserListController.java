...
public class UserListController {
	...
	public String searchUser(Model model, UserListForm form) {
		UserSearchInfo searchDto = new UserSearchInfo();
		searchDto.setLoginId(form.getLoginId());
		searchDto.setUserStatusKind(form.getUserStatusKind());
		searchDto.setAuthorityKind(form.getAuthorityKind());
